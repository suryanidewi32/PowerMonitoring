...
export default class ChartWBP extends Component {
    constructor(props) {
    super(props);
      ...
      async componentDidMount(){
        ...
        // const age=[];
        const time=[];
        await axios.get('http://localhost:3002/wbp')
        .then(Response=>{
        console.log("Response", Response.data.wbpValue[0]);
        for(const obj of Response.data.wbpValue[0])
        {
          console.log("obj", obj);
...
// class ChartWBP extends React.Component {
//   render() {
//     return (
//         <ReactFC
//         type="msarea"
